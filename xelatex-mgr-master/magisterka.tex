...
\title    {Generowanie płytek obwodu drukowanego w środowisku Python jako wtyczka do programu graficznego Blender}
\date     {2020}
\miejsce  {Gdańsk}
...
%Gerber (RS-274X)
%Excellon
%czytanie gerber/excellon: https://pcb-tools.readthedocs.io/en/latest/index.html

%do zaimplementowania: (niepotrzebne, zaimplementowane w Gerber)
%interpretacja klas z pakietu ‘gerber’
%graficzna interpretacja obiektów z klasy ‘gerber.primitives’
%rysowanie za pomocą krzywych


\chapter{Wprowadzenie do standardów Gerber cośtam cośtam}

...
Visual Studio Code jest to darmowy edytor kodu który według badań przeprowadzanych co roku przez serwis StackOverflow\footnote{https://insights.stackoverflow.com/survey/2018/\#development-environments-and-tools}\footnote{https://insights.stackoverflow.com/survey/2019\#development-environments-and-tools} cieszy się coraz większą popularnością. Wybór tego środowiska nie był jednak dyktowany jego popularnością lecz nowymi możliwościami otwierającymi się dzięki instalowaniu w nim rozszerzeń.\footnote{https://code.visualstudio.com/docs/editor/extension-gallery} Dodatek stworzony przez Jacques Lucke\footnote{https://marketplace.visualstudio.com/items?itemName=JacquesLucke.blender-development} na potrzeby rozwoju addonów \marginnote{czy mogę tu użyć słowa "addonów" czy jest to potoczny/angielszczyzm?} do programu Blender pozwala między innymi na automatyzację procesu aktualizowania tworzonego addonu przez tworzenie skrótu w wewnętrznych folderach Blendera co znacznie przyśpiesza pracę nad systemem. Ponadto posiada ułatwienia takie jak debugowanie w konsoli, tworzenie odpowiednich struktur i przydatne komendy. Sposób działania dodatku ma na celu także upewnienie się, że rozszerzenie nie koliduje z innym menedżerem pakietów Pythona.

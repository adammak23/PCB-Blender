...
Rozdział trzeci przedstawia implementację poszczególnych modułów równocześnie z przedstawieniem kolejności przepływu danych do poszczególnych komponentów i funkcji (kolejność podrozdziałów przedstawia także proces wykonywany w aplikacji). Ostatni rozdział omawia problemy napotkane podczas tworzenia oprogramowania, przedstawia możliwości rozwoju systemu oraz podsumowuje całokształt wykonanej pracy. 
...
% czy ten kod w ogóle jest potrzebny?, linijki musiały zostać przycięte i przechodzi on przez 2 strony
...
% opisać bardziej sposób renderowania (trochę nudne) + fragment kodu?
...
\section {Stworzenie bazy modeli, importer .wrl\label{wrl}}

W ramach pracy powstał także importer w celu stworzenia bazy modeli
...
% renderowanie dowolnej ilości warstw w dowolnej wybranej kolejności
% dopisywanie wyrażeń regularnych
...
% zakończenie
\summary
% cffi: version_info__ = (1, 14, 0)
% cairocffi: version_info = (1, 17, 2) (+skompilowana wersja cairo.dll, chyba niepotrzebna?)

...
% TODO: ZMIENIĆ STRESZCZENIE
%Rozdział 3 przedstawia implementację poszczególnych elementów równocześnie z przedstawieniem kolejności przepływu danych do poszczególnych komponentów i funkcji.(kolejność podrozdziałów przedstawia także proces wykonywany w aplikacji)
...
% czy ten kod w ogóle jest potrzebny?
\lstset{caption={Algorytm wyszukiwania komponentu po nazwie z uwzględnieniem całych słów (czy ten kod w ogóle jest potrzebny?)}}
\begin{lstlisting}

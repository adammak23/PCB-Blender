...
Każdy dodatek do Blendera musi posiadać obiekt \emph{bl\_info} zawierający metadane addonu implementować metody \emph{register()} oraz \emph{unregister()}. Wprowadzone w wersji 2.8 usprawnienia znacznie ułatwiają ten proces. Jeżeli nie potrzebujemy dodatkowych funkcjonalności podczas rejestrowania i usuwania dodatku lub jego komponentów, możemy użyć funkcji \emph{register\_classes\_factory} z pakietu \textbf{bpy.utils}, która automatycznie je zaimplementuje.

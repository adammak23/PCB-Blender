...
\begin{itemize}
\item Wybranie folderu zawierającego wszystkie pliki projektu PCB lub wybranie pojedynczych plików warstw i  plików pozycji elementów (eng. \emph{"Pick And Place"}) w formacie \emph{*.csv}\footnote{Więcej o strukturze plików projektowych PCB w punkcie 1.2.3}

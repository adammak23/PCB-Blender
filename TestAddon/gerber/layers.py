...
hints = [
    Hint(layer='top',
         ext=['gtl', 'cmp', 'top', ],
         name=['art01', 'top', 'GTL', 'layer1', 'soldcom', 'comp', 'F.Cu', 'F_Cu','top_copper' ],
         regex='',
         content=[]
         ),
    Hint(layer='bottom',
         ext=['gbl', 'sld', 'bot', 'sol', 'bottom', ],
         name=['art02', 'bottom', 'bot', 'GBL', 'layer2', 'soldsold', 'B.Cu', 'B_Cu','bottom_copper', ],
         regex='',
         content=[]
         ),
    Hint(layer='internal',
    ...
    Hint(layer='topsilk',
         ...
         name=['sst01', 'topsilk', 'silk', 'slk', 'sst', 'F.SilkS', 'F_SilkS','top_silk'],
         regex='',
         content=[]
         ),
    Hint(layer='bottomsilk',
         ext=['gbo', 'ssb', 'pls', 'bs', 'skb', 'bottomsilk', ],
         name=['bsilk', 'ssb', 'botsilk', 'bottomsilk', 'B.SilkS', 'B_SilkS','bottom_silk',],
         regex='',
         content=[]
         ),
    Hint(layer='topmask',
         ...
         name=['sm01', 'cmask', 'tmask', 'mask1', 'maskcom', 'topmask',
               'mst', 'F.Mask', 'F_Mask','top_solder_mask','top_soldermask'],
         regex='',
         content=[]
         ),
    Hint(layer='bottommask',
         ...
         name=['sm', 'bmask', 'mask2', 'masksold', 'botmask', 'bottommask',
               'msb', 'B.Mask', 'B_Mask','bottom_solder_mask', 'bottom_soldermask'],
         regex='',
         content=[]
         ),
    Hint(layer='toppaste',
         ext=['gtp', 'tm', 'toppaste', ],
         name=['sp01', 'toppaste', 'pst', 'F.Paste', 'F_Paste', 'top_paste_mask'],
         regex='',
         content=[]
         ),
    Hint(layer='bottompaste',
         ext=['gbp', 'bm', 'bottompaste', ],
         name=['sp02', 'botpaste', 'bottompaste', 'psb', 'B.Paste', 'B_Paste','bottom_paste_mask',],
         regex='',
         content=[]
         ),
    Hint(layer='outline',
         ext=['gko', 'outline', ],
         name=['BDR', 'border', 'out', 'outline', 'Edge.Cuts', 'Edge_Cuts', 'EdgeCuts', 'board_outline',],
         regex='',
         content=[]
         ),

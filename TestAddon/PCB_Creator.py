    ...
    if extension != requested_extension:
        ...
        for line in file_linesplitted:
            ...
            if len(line)==14 and line[0]=='X': # coordinates
                ...
                bpy.ops.mesh.primitive_uv_sphere_add(radius=mil_to_meters(current_drill_size), enter_editmode=False, location=(mil_to_meters(Vector2[0]), mil_to_meters(Vector2[1]), 0))
...
class GenerateOperator(Operator):
    ...
    def execute(self, context):
        # remove all objects on the scene
